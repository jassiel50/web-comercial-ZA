...
3. **Caso de estudio × 3** (`caso-inventario.dc.html`, `caso-portal.dc.html`, `caso-plataforma.dc.html`) — Header con tags, imagen hero con badge glass "Vista previa", layout de 2 columnas: Problema/Solución (con 2 imágenes) a la izquierda, sidebar "El resultado" con bloques de borde izquierdo acentuado a la derecha, stack técnico, CTA.
